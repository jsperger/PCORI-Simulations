...
GenContinuousCovariates <- function(n.subj = N, d.unif = p.unif, d.norm = p.norm){
...
GenBinaryCovariates <- function(n.subj = N, d.bin = p.bin, props = bin.props){
  if(length(bin.props) != d.bin ){
